<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-text>
            ...
            <String label="CancleDt" v-model="value.cancleDt" :editMode="editMode" :inputUI="''"/>
            <String label="PaymentMethod" v-model="value.paymentMethod" :editMode="editMode" :inputUI="''"/>
            <String label="Ammount" v-model="value.ammount" :editMode="editMode" :inputUI="''"/>
            <Number label="Qty" v-model="value.qty" :editMode="editMode" :inputUI="''"/>
            <String label="ReqType" v-model="value.reqType" :editMode="editMode" :inputUI="''"/>
        </v-card-text>
